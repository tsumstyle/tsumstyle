...
- 🐚 **[Minishell](https://github.com/Bernhardbiermann/42_minishell)** · `C`
  ...
  **Worked on:** Process creation and management, pipes, redirections,
  environment variables, signals and built-in commands.

- 🎮 **[Cub3D](https://github.com/tsumstyle/cub3d)** · `C`

  A raycasting-based 3D game inspired by early Wolfenstein-style rendering,
  using MiniLibX for graphics programming.

  **Worked on:** Raycasting, 2D map parsing, textures, sprites and event handling.
